...
journal_data = pd.read_excel("C:\\Users\\BFI User\\Desktop\\AER_2000-2022.xlsx")
...
for index, row in journal_data.iterrows():
    ...
    m = soup.find_all("section", {"class": "primary article-detail journal-article"})
    m = m[0].find_all('a', {'class': 'button'})
    tail = m[0].attrs['href']
    x = 'https://www.aeaweb.org' + tail
